...
- 导航守卫 `beforeEach`
- `meta.requiresAuth / adminOnly / studentOnly`
...
- “我通过 Vue Router 管理页面切换，并通过路由守卫限制学生端和管理员端访问权限。”
...
- 理解为什么这个项目不只是前台展示，而是有完整的前后台闭环，这也是优秀答辩的重要点。
...
- `src/views/admin/AdminActivitiesView.vue`
- `src/views/admin/AdminActivityFormView.vue`
...
- 能说清管理员能做什么、学生能做什么
- 能解释“管理员新增/编辑活动后，前台为什么会更新”
- 能说明为什么一个后台页可以同时服务“新增”和“编辑”

答辩表达必须会说：

- “管理员端负责维护活动内容，学生端负责消费活动内容，这样形成了完整业务闭环。”
- “活动数据由接口和 Vuex 统一管理，管理端修改后重新拉取即可同步到前台。”
...
- “我的项目不仅满足了基础技术要求，还通过学生端和管理员端形成完整业务闭环。”
